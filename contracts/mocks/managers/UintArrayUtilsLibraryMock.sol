...
import { UintArrayUtilsLibrary } from "../../managers/lib/UintArrayUtilsLibrary.sol";

/**
 * @title UintArrayUtilsLibraryMock
 * @author Set Protocol
 *
...
library UintArrayUtilsLibraryMock {
    ...
    function sumArrayValues(
        ...
        returns (uint256)
    {
        return UintArrayUtilsLibrary.sumArrayValues(_array);
    }
}